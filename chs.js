...
var cnItems = {
    ...
    "Small prestige for the first time. Makes Small Prestiges boost production.": "第一次小声望。 使小声望提高产量。",
    ...
    "Microprestige for the first time. Makes Microprestiges boost production.": "第一次微声望。 使 微声望 提高产量。",
    ...
    "Get 2 Miniprestiges. Multiplies point gain by 49, divides Microprestige requirement by 2, and adds new upgrades.": "获得2个小型捕获。将点增益乘以49，将MicroPrestige要求除以2，并增加了新的升级。",
    "Get 3 Miniprestiges. You now keep Micro upgrades on Miniprestige.": "获得3个小型捕获。现在，您将微型升级保持在Miniprestige上。",
    "Get 6 Microprestiges. Microprestige no longer resets Nanoprestige upgrades.": "获取6个微架试验。 MicroPrestige不再重置Nanoprestige升级。",
    "Gilded Age": "镀金时代",
    "Micro upgrade 14. Shows Buyable menu on Microprestige.": "微型升级14.在MicroPrestige上显示可购买的菜单。",
    "Micromint": "微标",
    "Micropoint": "微点数",
    "Micropush": "微促进",
    "Mini upgrade 13. Unlocks BN upgrades 12, 13, 14, 15": "迷你升级13.解锁BN升级12、13、14、15",
    "Miniprestige for the first time. Unlocks the Upgrade subtab on all layers.": "第一次微型果。解锁所有层上的升级子选项卡。",
    "Miniprestiges": "微型捕获",
    "Nano upgrade 13. Shows Buyable menu on Nanoprestige.": "纳米升级13.在Nanoprestige上显示可购买的菜单。",
    "Nano upgrade 44. Shows Challenge menu on Nanoprestige.": "纳米升级44.在Nanoprestige上显示挑战菜单。",
    "Nanoclick": "纳米点击",
    "Nanopoint": "纳米点数",
    "Nanoprestige cost divided by Nanoprestige's effect.": "Nanoprestige成本除以Nanoprestige的效果。",
    "Nanoprestige cost is divided by 3.": "Nanoprestige成本除以3。",
    "Nanopush": "纳米促进",
    "Nanoshove": "纳米推进",
    "Point gain is multiplied by 7.": "点增益乘以7。",
    "Prefacing conclusions": "预定结论",
    "Purchase BUYABLE ENLARGEMENT. Unlocks 1 buyable in Nano, Micro, and Broken Nano, Mini, and Small. Also unlocks Microfinale.": "购买可购买的扩大。解锁1在纳米，微型和破碎的纳米，迷你和小型中可购买。也解锁了缩影。",
    "Purchase MICRO ENLARGEMENT. Unlocks Micro upgrades 61, 62, 63, 64, and 65.": "购买微型扩大。解锁微型升级61、62、63、64和65。",
    "Purchase MINI ENLARGEMENT. Unlocks Mini upgrades 31, 32, 33, and 34.": "购买迷你扩大。解锁迷你升级31、32、33和34。",
    "Purchase NANO ENLARGEMENT. Unlocks Nano upgrades 91, 92, 93, 94, and 95.": "购买纳米增大。解锁Nano升级91、92、93、94和95。",
    "Purchase Nanopierce at least once.": "至少购买一次纳米副手。",
    "Purchase SMALL ENLARGEMENT. Unlocks Small upgrades 11, 12, 13, 14, and 15.": "购买小型扩大。解锁小型升级11、12、13、14和15。",
    "Purchase Smallprestige upgrade 11. Unlocks the Small Force minigame.": "购买SmallPrestige升级11.解锁小型迷你游戏。",
    ...
    "Current endgame at 25 Smallprestiges!": "当前残局为 25 小声望！",
    "AC": "AC",
    "N": "N",
    "i": "i",
    "μ": "μ",
...
var cnRegReplace = new Map([
    ...
    [/^You have (.+) Smallprestige$/, '你有 $1 小声望'],
    ...
    [/^([\d\.,]+) Smallprestige$/, '$1 小声望'],
    [/^([\d\.,]+) Microprestiges$/, '$1 微声望'],
    [/^([\d\.,]+) Miniprestige$/, '$1 迷你声望'],
    [/^([\d\.,]+) Nanoprestiges$/, '$1 纳米声望'],
    [/^([\d\.,]+) Communals. Unlocks:$/, '$1 公共. 解锁:'],
    [/^([\d\.,]+) Smallprestige. Unlocks:$/, '$1 小声望. 解锁:'],
    [/^([\d\.,]+) elves$/, '$1 精灵'],
    ...
    [/^Req: (.+) points$/, '要求：$1 点数'],
    [/^Req: (.+) elves$/, '要求：$1 精灵'],
    [/^Req: (.+) \/ (.+) Microprestiges$/, '要求：$1 \/ $2 微声望'],
    [/^Req: (.+) \/ (.+) Smallprestige$/, '要求：$1 \/ $2 小声望'],
