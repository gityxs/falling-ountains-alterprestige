...
var cnItems = {
    ...
    "Add 500 free levels to Boost IV for every Communal.": "为每个 Communal 增加 500 个免费关卡到 Boost IV。",
    "Add 500 free levels to Boost V for every Communal.": "为每个 Communal 增加 500 个免费关卡到 Boost V。",
    "Add 500 free levels to Boost VI for every Communal.": "为每个 Communal 增加 500 个免费关卡到 Boost VI。",
    "Add a free level to Boost I for every Capital.": "为每个首都添加一个免费级别来提升 I。",
    "Add a free level to Boost II for every Capital.": "为每个首都添加一个免费级别到 Boost II。",
    "Add a free level to Boost III for every Capital.": "为每个首都添加一个免费级别到 Boost III。",
    "Add Capitals to the Miniexplode formula, and multiply Microprestige gain by log10(Break Constant)": "将大写字母添加到 Miniexplode 公式中，并将 Microprestige 增益乘以 log10（断裂常数）",
    "Autobuy Microprestige buyables, and unlock a new one.": "Autobuy Microprestige 可购买，并解锁一个新物品。",
    "Autobuy the first 3 Broken Nano buyables.": "自动购买前 3 个 Broken Nano 可购买。",
    ...
    "Break Constant power is increased by 1.25x.": "Break Constant 威力增加 1.25 倍。",
    "BREAK IV": "休息四",
    "BREAK V": "休息五",
    "BREAK VI": "休息六",
    "Capital": "首都",
    ...
    "Capitals exponentiate multiplier to Nanoprestige gain.": "资本将乘数乘以 Nanoprestige 增益。",
    "Cascaded Micro": "级联微型",
    "Change the 1.12 in Nanobuff's cost formula to a 1.1.": "将 Nanobuff 成本公式中的 1.12 更改为 1.1。",
    "Communal": "公用",
    "Cost: Infinity Nanoprestiges.Cost scaling: 1e40+1e40*3^(x^1.5)": "成本：Infinity Nanoprestiges。成本缩放：1e40+1e40*3^(x^1.5)",
    "Cube the Nanoprestige effect.": "立方纳米威望效应。",
    "Divide Microprestige requirement based on Miniprestiges.": "根据 Miniprestiges 划分 Microprestige 要求。",
    ...
    "Each level of Minibuff increases the effect more exponentially.": "Minibuff的每一级都会以指数方式增加效果。",
    "Extra Levels: 2.00": "额外等级：2.00",
    "Get more than e1.79e308 points. Smallprestige no longer resets Miniprestige upgrades.": "获得超过e1.79e308分。 Smallprestige 不再重置 Miniprestige 升级。",
    "Give 2.80e22 free levels to Nanomuscle.": "为 Nanomuscle 提供 2.80e22 个免费关卡。",
    "Improve the Break Constant formula by a small amount.": "少量改进 Break Constant 公式。",
    "Increase bulk buy by +5. Each Communal divides Capital requirements.": "批量购买增加+5。每个公社划分资本要求。",
    ...
    "Makes Nanophase work on Nanogains, and double its power. Also reduce Nano cost scaling.": "使 Nanophase 在 Nanogains 上工作，并使其功率加倍。还可以降低 Nano 成本缩放。",
    ...
    "Minirelief": "迷你浮雕",
    "1.2 for each row completed. Nanoprestige upgrades never reset on any reset.": "每行完成1.2个。 Nanoprestige 升级不会在任何重置时重置。",
    "log10(Nanoprestige Fragments)^0.6": "log10(纳米声望碎片)^0.6",
    "Multiply Miniprestige gain by 1.22x per Capital (capped at 2x)": "将每个资本的 Miniprestige 收益乘以 1.22 倍（上限为 2 倍）",
    "log(log(points)).": "log（log(点数)）。",
    "Multiply the power of the first row of Nano buyables by 17,527,497": "将第一排 Nano 可购买的功率乘以 17,527,497",
    "Nanoagain": "纳米再次",
    "Nanobalance": "纳米平衡",
    "Nanofinale": "纳米压轴",
    "Nanofinale 2": "纳米压轴 2",
    ...
    "Nanoprestige challenges are never reset. Exponentiate Nanoprestige Fragment gain and Capital scaling based on rows complete.": "Nanoprestige 挑战永远不会被重置。根据完成的行对 Nanoprestige 片段增益和资本缩放进行指数化。",
    "Nanoprestige Fragments boost Nanoprestige gain exponent.": "Nanoprestige 碎片提升 Nanoprestige 增益指数。",
    "Nanoprestiges boost Nanoprestige fragment gain more.": "Nanoprestiges 提高 Nanoprestige 片段增益更多。",
    "Nanoretain": "纳米保留",
    "Nanoscale": "纳米级",
    "Nanostrawman": "纳米稻草人",
    "Nanoupward": "纳米向上",
